...
public class AppHelper {
     ...
     */
    private static final String userPoolId = "us-east-1_PZAAo0teM";

    /**
     * Add you app id
     */
    private static final String clientId = "4hm6sblk3s5gq818ks14nogpcr";
     ...
     */
    private static final String clientSecret ="fbt37povbm68h9dr2e1mlpkqfdbektgualdshs7t8i4upcac344";
            ...
            if(keySet.contains(det)) {
                ...
                if(det.contains("email")) {
                    if(emailVerified) {
                        ...
                        item.setMessageColor(Color.WHITE);
                    }
                    else {
